...
public class Message {
	...
	public static Message forDelivery(Delivery delivery) {
		if (delivery != null) {
			return new DeliveredMessage(delivery);
		} else {
			return NONE;
		}
	}
	...
	public static Message forSending(
		...
		if (body != null && exchangeName != null) {
			return new MessageForSending(body, headers, exchangeName, routingKey, contentType, contentEncoding, persistent, messageId);
		} else {
			return NONE;
		}
	}
